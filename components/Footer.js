...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-slate-900 to-slate-950 text-white mt-auto">
      {/* Wave Decoration */}
      <div className="h-16 bg-gradient-to-b from-slate-100 to-slate-900 -mb-1">
        <svg viewBox="0 0 1440 100" className="w-full h-full">
          <path 
            fill="#0f172a" 
            d="M0,40 C360,100 720,0 1080,50 C1260,75 1380,65 1440,60 L1440,100 L0,100 Z"
          />
        </svg>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-400 max-w-md leading-relaxed">
              Smart journeys start here. Discover breathtaking destinations across India and around the world. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/region/india" className="text-slate-400 hover:text-white transition-colors">Explore India</Link></li>
              <li><Link href="/region/international" className="text-slate-400 hover:text-white transition-colors">International</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-slate-500 text-sm flex items-center gap-1">
            ...
            using 
            <span className="text-amber-400 font-medium">Contentstack</span> 
            + 
